#!/bin/bash
# ==============================================================================
# ChIP-Seq SRA Data Download and Formatting Pipeline (with Prefetch)
...
echo "Starting robust ChIP-Seq download pipeline..."

# ====================================================================
# Pipeline Execution Loop
# ====================================================================
# Filter "ChIP-Seq" entries from the metadata and process them in a loop
grep "ChIP-Seq" "$METADATA" | while IFS=, read -r Run SampleName LibraryName AssayType
do
    ...
    echo "=========================================================="
    echo " Processing ChIP-Seq Sample: $LibraryName (SRA: $Run)"
    echo "=========================================================="
...
echo "=========================================================="
echo " All ChIP-Seq datasets have been downloaded and formatted! "
echo "=========================================================="